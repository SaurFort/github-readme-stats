...
#### Options exclusives de carte WakaTime
...
GitHub gist pins vous autorise à épingler l'essentiel sur votre profil GitHub en utilisant un profil GitHub readme
...
3. Connecter vous avec GitHub en appuyant sur `Continue with GitHub`.
   ![](https://files.catbox.moe/b9oxey.png)
4. Connecter vous à GitHub et autoriser l'accés à tout les répertoires si demander.
5. Forkez ce répertoire.
6. Retourner en arrière sur votre [tableau de bord Vercel](https://vercel.com/dashboard).
7. Pour importer un projet, cliquer sur le bouton `Add New...` et séléctionner l'option `Project`.
8. Cliquer sur le bouton `Continue with GitHub`, chercher pour les prérequis d'un répertoire Git et importer les en cliquant sur le bouton `Import`. Autrement, vous pouvez importer un répertoire Git tiers en utilisant le lien `Import Third-Party Git Repository ->` en bas de la page.
   ![](https://files.catbox.moe/mg5p04.png)
9. Créer un token d'accés personnel (PAT) [ici](https://github.com/settings/tokens/new) et activé les permissions `repo` et `user` (cela autorise les accés pour voir les répertoires privée et les statistiques de l'utilisateur).
10. Ajouter le PAT en tant que variable d'environnement nommé `PAT_1` (comme affiché).
    ![](https://files.catbox.moe/0yclio.png)
11. Cliquer sur déployer, et tout est bon. Regarder vos domaines utiliser l'API !
...
<details>
<summary><b>:hammer_and_wrench: Guide étape par étape pour déployer sur les autres plateformes</b></summary>

1.  Forker ou cloner le répertoire fonction de vos besoins
2.  Ajouter `express` au dépendance dans la section `package.json`
    <https://github.com/anuraghazra/github-readme-stats/blob/ba7c2f8b55eac8452e479c8bd38b044d204d0424/package.json#L54-L61>
3.  Exécuter `npm i` si nécessaire (installation initial)
4.  Exéctuer `node express.js` pour lancer le serveur ou définir le point d'entré pour `express.js` dans `package.json` si vous déployez ça sur un service manager.
...
*   Faite un don que vous jugez approprié lorsque vous utilisez github-readme-stats sur votre readme, avec un lien vers celui-ci :D
